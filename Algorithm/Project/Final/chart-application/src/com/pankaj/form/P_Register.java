            ...
            PublicEvent.getInstance().getEventLogin().register(data, new EventMessage() {
                ...
                public void callMessage(Model_Message message) {
                    if (!message.isAction()) {
                        ...
                        JOptionPane.showMessageDialog(null, "Registration successful. Please log in."); // Display success message
                        // Navigate to the login page
                        P_Login loginPage = new P_Login();
                        loginPage.setVisible(true);
                      //  disposeFrame(); // Dispose the current registration page
                    }
                }
